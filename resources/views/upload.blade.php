                  ...
                  <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    {{-- <div class="overflow-x-auto"> --}}
                      <div class="flex overflow-x-auto">
                          ...
                          @if($index == 0)
                          <div class="flex flex-col sticky left-0 bg-white shadow">
                            @foreach($column as $row => $item)
                            <div class="border p-2" style="height: 2rem; line-height: 1rem">
                              <input type="checkbox" name="rows[]" id="check-row-{{ $row }}" value="{{ $row }}" checked>
                            </div>
                            @endforeach
                          </div>
                          @endif
                            <div class="flex flex-col">
                              ...
                              <div class="border p-2 whitespace-pre" style="height: 2rem; line-height: 1rem">{{ $item }}</div>
                              @endforeach
                            </div>
                          @endforeach
                      </div>
